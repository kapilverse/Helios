...
impl OtReconciler {
    ...
    pub fn transform(&self, a: &Op, b: &Op) -> Op {
        match (a, b) {
            ...
            (
                Op::Insert { id: id_a, after: after_a, content: content_a },
                Op::Insert { id: id_b, after: after_b, content: _ },
            ) => {
                if after_a == after_b {
...
mod tests {
    ...
    fn test_insert_insert_same_position_lower_peer_wins() {
        ...
        let a = Op::Insert { id: OpId::new(peer(1), 1), after: None, content: 'A' };
        let b = Op::Insert { id: OpId::new(peer(2), 1), after: None, content: 'B' };
    ...
    fn test_insert_insert_same_position_higher_peer_shifts() {
        let r = OtReconciler::new();
        let a = Op::Insert { id: OpId::new(peer(2), 1), after: None, content: 'B' };
        let b = Op::Insert { id: OpId::new(peer(1), 1), after: None, content: 'A' };

        let result = r.transform(&a, &b);
        assert_eq!(
            result,
            Op::Insert { id: OpId::new(peer(2), 1), after: Some(OpId::new(peer(1), 1)), content: 'B' },
    ...
    fn test_insert_insert_different_position_no_change() {
        let r = OtReconciler::new();
        let a = Op::Insert { id: OpId::new(peer(1), 1), after: None, content: 'A' };
        let b = Op::Insert { id: OpId::new(peer(2), 1), after: Some(OpId::new(peer(3), 1)), content: 'B' };
    ...
    fn test_insert_insert_convergence() {
        ...
        let a = Op::Insert { id: OpId::new(peer1, 1), after: None, content: 'A' };
        let b = Op::Insert { id: OpId::new(peer2, 1), after: None, content: 'B' };
        ...
        assert_eq!(doc1.content(), doc2.content(), "must converge after transform");
    }
    ...
    fn test_insert_delete_target_match() {
        ...
        let a = Op::Insert { id, after: None, content: 'A' };
        let b = Op::Delete { target: id };

        let result = r.transform(&a, &b);
        assert_eq!(result, a, "insert deleted by concurrent op — no change to a");
    }
    ...
    fn test_insert_delete_no_match() {
        let r = OtReconciler::new();
        let a = Op::Insert { id: OpId::new(peer(1), 1), after: None, content: 'A' };
        let b = Op::Delete { target: OpId::new(peer(2), 1) };
    ...
    fn test_delete_insert_deleting_inserted_element() {
        ...
        let b = Op::Insert { id, after: None, content: 'A' };
    ...
    fn test_delete_insert_different_target() {
        let r = OtReconciler::new();
        let a = Op::Delete { target: OpId::new(peer(1), 1) };
        let b = Op::Insert { id: OpId::new(peer(2), 1), after: None, content: 'B' };
    ...
    fn test_setkey_same_key_newer_wins() {
        ...
        let a = Op::SetKey { map_id, key: "k".into(), value: Value::Text("old".into()), ts: 1 };
        let b = Op::SetKey { map_id, key: "k".into(), value: Value::Text("new".into()), ts: 2 };
    ...
    fn test_setkey_same_key_same_timestamp() {
        let r = OtReconciler::new();
        let map_id = OpId::new(peer(1), 1);
        let a = Op::SetKey { map_id, key: "k".into(), value: Value::Text("a".into()), ts: 1 };
        let b = Op::SetKey { map_id, key: "k".into(), value: Value::Text("b".into()), ts: 1 };
    ...
    fn test_setkey_different_keys() {
        let r = OtReconciler::new();
        let map_id = OpId::new(peer(1), 1);
        let a = Op::SetKey { map_id, key: "x".into(), value: Value::Text("a".into()), ts: 1 };
        let b = Op::SetKey { map_id, key: "y".into(), value: Value::Text("b".into()), ts: 2 };
    ...
    fn test_setkey_vs_insert() {
        let r = OtReconciler::new();
        let a = Op::SetKey { map_id: OpId::new(peer(1), 1), key: "k".into(), value: Value::Text("v".into()), ts: 1 };
        let b = Op::Insert { id: OpId::new(peer(2), 1), after: None, content: 'X' };
    ...
    fn test_reconcile_full_cycle() {
        ...
        let op1 = Op::Insert { id: OpId::new(peer(1), 1), after: None, content: 'H' };
        doc.apply(op1.clone());

        let op2 = Op::Insert { id: OpId::new(peer(2), 1), after: None, content: 'W' };
    ...
    fn test_reconcile_multiple_ops() {
        ...
        let ops: Vec<Op> = (0u8..5).map(|i| {
            Op::Insert {
                id: OpId::new(peer(1), (i + 1) as u64),
                after: if i == 0 { None } else { Some(OpId::new(peer(1), i as u64)) },
        ...
        let incoming = Op::Insert { id: OpId::new(peer(2), 1), after: None, content: 'Z' };
